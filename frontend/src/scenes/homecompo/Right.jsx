...
const FriendsList = () => {
  ...
  const fetchFriends = async () => {
    ...
    setLoading(true);
    try {
      const res = await axios.get(`http://localhost:3000/users/${user._id}/friends`, {
          ...
          <ListItem
            ...
            secondaryAction={
              <IconButton edge="end" onClick={() => toggleFriend(f._id)}>
                ...
                <PersonRemoveIcon sx={{ color: '#0f9d58' }} />
              </IconButton>
            }
          >
            <ListItemAvatar>
            ...
            <ListItemText
              ...
              secondary={
                <Typography variant="body2" color="gray">{f.occupation}</Typography>
              }
            />
          </ListItem>
        ))}
